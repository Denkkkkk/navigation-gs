...
#ifndef NEUPAN_CONTROLLER__PARAMETER_HANDLER_HPP_
#define NEUPAN_CONTROLLER__PARAMETER_HANDLER_HPP_
...
/**
 * @class neupan_controller::ParameterHandler
...
public:
  /**
   * @brief Constructor for neupan_controller::ParameterHandler
   */
  ParameterHandler(
  ...
  /**
   * @brief Destrructor for neupan_controller::ParameterHandler
   */
  ~ParameterHandler();
...
#endif  // NEUPAN_CONTROLLER__PARAMETER_HANDLER_HPP_
